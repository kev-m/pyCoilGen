...
def stream_function_optimization(coil_parts: List[CoilPart], target_field, input_args, m_debug=None):
    ...
    tikonov_reg_factor = input_args.tikonov_reg_factor
    ...
    for part_ind in range(len(coil_parts)):
        ...
        if part_ind == 0:
            ...
            gradient_sensitivity_matrix = np.concatenate([gradient_sensitivity_matrix, coil_part.sensitivity_matrix], axis=2)
    ...
    if input_args.sf_opt_method == "tikkonov":
